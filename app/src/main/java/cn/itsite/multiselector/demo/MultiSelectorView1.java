...
//        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, cn.itsite.multiselector.R.styleable.MultiSelector, 0, 0);
//        try {
//            if (a.hasValue(cn.itsite.multiselector.R.styleable.MultiSelector_nomalColor)) {
//                nomalColor = a.getColor(cn.itsite.multiselector.R.styleable.MultiSelector_nomalColor, 0);
//            }
//            if (a.hasValue(cn.itsite.multiselector.R.styleable.MultiSelector_selectedColor)) {
//                selectedColor = a.getColor(cn.itsite.multiselector.R.styleable.MultiSelector_selectedColor, 0);
//            }
//            if (a.hasValue(cn.itsite.multiselector.R.styleable.MultiSelector_indicatorColor)) {
//                mIndicatorColor = a.getColor(cn.itsite.multiselector.R.styleable.MultiSelector_indicatorColor, 0);
//            }
//            tabVisible = a.getBoolean(cn.itsite.multiselector.R.styleable.MultiSelector_tabVisible, true);
//            mMode = a.getInt(cn.itsite.multiselector.R.styleable.MultiSelector_mode, TabLayout.MODE_FIXED);
//            inflate(context, cn.itsite.multiselector.R.layout.view_selector, this);
//
//        } finally {
//            a.recycle();
//        }
...
//        mTabLayout = (TabLayout) findViewById(cn.itsite.multiselector.R.id.tabLayout);
...
//        mViewPager = (ViewPager) findViewById(cn.itsite.multiselector.R.id.viewPager);
...
//            return new BaseViewHolder(LayoutInflater.from(parent.getContext()).inflate(cn.itsite.multiselector.R.layout.item_rv_selector, parent, false));
//        }
//
//        @Override
...
//            super(view);
//            mTextView = (TextView) view.findViewById(cn.itsite.multiselector.R.id.tv);
//        }
//    }
//
